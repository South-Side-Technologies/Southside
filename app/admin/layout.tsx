    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        <nav className="w-64 bg-white border-r border-gray-200 px-4 py-6 hidden lg:block">
          <div className="mb-6">
            <h2 className="text-xl font-bold text-red-700 mb-2">Admin Panel</h2>
          ...
          <div className="space-y-2">
            <Link
              href="/admin"
              className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-red-50 hover:text-red-700 transition-colors"
            >
