...
export default function TicketDetail() {
  ...
  return (
    <>
      <Link href="/admin/tickets" className="text-red-700 hover:text-red-900 mb-4 inline-block">
        ← Back to Tickets
      </Link>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <button
              ...
              disabled={saving}
              className="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg disabled:opacity-50 transition-colors"
            >
              Delete Ticket
            </button>
          </div>
