    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm font-medium">Payments</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        {/* Support Tickets */}
        <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 ${!stripeOnboardingComplete ? 'opacity-50 pointer-events-none' : ''}`}>
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Support Tickets</h2>
          <div className="space-y-2">
            <p className="text-sm text-gray-600">Open/In Progress Tickets</p>
            <p className="text-3xl font-bold text-gray-900">{assignedTickets}</p>
            {stripeOnboardingComplete ? (
              <Link
      ...
      {stripeOnboardingComplete ? (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-8">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Currently Assigned Projects</h2>
          </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-600">{assignment.project.progress}%</span>
                        </div>
                      </td>
                    </tr>
                  ))
        ...
        <div className="bg-gray-50 rounded-xl border border-gray-200 overflow-hidden mb-8 p-8">
          <div className="text-center">
            <svg className="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Projects Locked</h3>
            <p className="text-gray-600 mb-4">Complete your payment setup to view and work on assigned projects</p>
            <Link
              href="/contractor/payments"
