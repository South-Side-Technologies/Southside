    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-gray-400 text-lg">Unable to load user information</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="text-gray-400 back, {currentUser.name || currentUser.email}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm font-medium">Assigned Projects</p>
        ...
        <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{inProgressProjects}</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm font-medium">Open Tickets</p>
              <p className="text-3xl font-bold text-gray-900 mt-2">{assignedTickets}</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm font-medium">Payments</p>
              <p className="text-gray-900 font-medium mt-2 text-sm">Manage earnings</p>
              <Link
                href="/contractor/payments"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        {/* Support Tickets */}
        <div className={`bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6 ${!stripeOnboardingComplete ? 'opacity-50 pointer-events-none' : ''}`}>
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Support Tickets</h2>
          <div className="space-y-2">
            <p className="text-sm text-gray-400 Progress Tickets</p>"
            ...
            {stripeOnboardingComplete ? ("
              ...
              <p className="text-sm text-gray-400 mt-2">Complete payment setup to view tickets</p>
            )}
          </div>
        </div>
      </div>
      ...
      {stripeOnboardingComplete ? (
        ...
        <<div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden mb-8 p-8">
          <div className="text-center">
            <svg className="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Projects Locked</h3>
            <p className="text-gray-400 mb-4">Complete your payment setup to view and work on assigned projects</p>
            <Link
              href="/contractor/payments"
