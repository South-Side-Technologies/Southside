          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full px-6 py-3 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition"
              >
                Resubmit Application
              </button>
              <Link
                href="/dashboard"
                className="block w-full px-6 py-3 bg-gray-100 text-gray-900 font-medium rounded text-center hover:bg-gray-200 transition"
              >
                Back to Dashboard
              </Link>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Work on your own schedule and choose projects</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Get paid directly for quality work</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Connect with other professionals</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Simple onboarding process</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <button
                onClick={() => router.push('/contractor/onboarding')}
                className="flex-1 px-6 py-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition text-lg"
              >
                Get Started
              </button>
              <Link
                href="/dashboard"
                className="flex-1 px-6 py-4 bg-gray-100 text-gray-900 font-semibold rounded-lg hover:bg-gray-200 transition text-center text-lg"
              >
                Learn More
              </Link>
            </div>
