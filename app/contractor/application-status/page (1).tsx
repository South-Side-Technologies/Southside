        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-4">
              <Link
                href="/contractor/onboarding"
                className="w-full px-6 py-3 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition text-center block"
              >
                Resubmit Application
              </Link>
              <Link
                href="/dashboard"
                className="w-full px-6 py-3 bg-gray-100 text-gray-900 font-medium rounded text-center hover:bg-gray-200 transition"
              >
                Back to Dashboard
              </Link>
            </div>
