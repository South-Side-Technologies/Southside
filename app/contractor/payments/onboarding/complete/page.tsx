        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-2">Your payment method is ready. You'll now receive payments when you complete projects.</p>
            </div>
    ...
    return (
      <>
        <div className="mb-8">
          ...
          <p className="text-gray-600">Your payment method is being verified</p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-2">Stripe is reviewing your information. This usually takes a few hours.</p>
            </div>
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="text-gray-600">We couldn't verify your onboarding status</p>
      </div>
