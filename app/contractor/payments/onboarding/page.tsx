  ...
  return (
    <div className="min-h-screen bg-gray-900 p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Set Up Payment Method</h1>
          <p className="text-gray-300">Link your bank account to receive contractor payments</p>
        </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Set up your Stripe account</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Provide your information</h3>
                  <p className="text-sm text-gray-400 mt-1">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white">Start getting paid</h3>
                  <p className="text-sm text-gray-400 mt-1">
