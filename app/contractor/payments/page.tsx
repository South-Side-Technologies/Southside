    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-gray-400 payment dashboard...</p>
        </div>
      </div>
    )
  }
    ...
    return ("
      <<div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Link href="/contractor" className="text-red-700 hover:text-red-900:text-red-300">
            Back to Dashboard
          </Link>
        </div>
      </div>
    ...
    return (
      <>
        <div className="mb-8">
          ...
          <p className="text-gray-400 paid for your work</p>
        </div>"
        <<div className="max-w-2xl mx-auto">
          <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Set Up Your Payment Method</h2>
            ...
            <div className="bg-gray-800 rounded-lg p-6 mb-6 text-left space-y-3">
              <div className="flex gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 your bank account</h3>"
                  <<p className="text-sm text-gray-400 link your bank details for direct deposits</p>
                </div>
              </div>"
              <<div className="flex gap-3">
                <div className="flex-shrink-0 flex items-center justify-center h-8 w-8 rounded-md bg-blue-600 text-white text-sm font-medium">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 earning payments</h3>"
                  <<p className="text-sm text-gray-400 paid when projects are completed and processed</p>
                </div>
              </div>"
              <<div className="flex gap-3">
                <div className="flex-shrink-0 flex items-center justify-center h-8 w-8 rounded-md bg-blue-600 text-white text-sm font-medium">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 your earnings</h3>"
                  <<p className="text-sm text-gray-400 all your payments and earnings history</p>
                </div>
              </div>
            </div>"
            <<Link
  ...
  return (
    <>
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Payment Dashboard</h1>
          <p className="text-gray-400 your contractor payments and earnings</p>
        </div>"
        <<button
        ...
        <div className="bg-gray-800 rounded-xl shadow-sm border border-gray-700 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">{data.completedProjects}</p>
            </div>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200
                {data.completedAssignments.map((assignment) => ("
                  <<tr key={assignment.id} className="hover:bg-gray-800 transition">
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"
                      <<Link
                        href={`/contractor/projects/${assignment.projectId}`}
                        className="text-red-700 hover:text-red-900:text-red-300"
                      >
